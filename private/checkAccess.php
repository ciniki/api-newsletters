...
// <rsp stat="ok" />
//
function ciniki_newsletters_checkAccess($ciniki, $tnid, $method) {
    //
    ...
    $rc = ciniki_tenants_checkModuleAccess($ciniki, $tnid, 'ciniki', 'newsletters');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    $modules = $rc['modules'];
    ...
    //
    // Users who are an owner or employee of a tenant can see the tenant newsletters
    //
